...
public class AddressBookService implements AddressBookServiceInterface {
    ...
    /**
     *
     * addressBook contains address book of all company
     * companyName contains the address book 'key'
     * personArrayList contains all the persons information in particular company/address book
     */
    @Override
     ...
     * addressBook contains all the company/address book
     */
    @Override
     ...
     * addressBooks contain multiple address book
     */
    @Override
